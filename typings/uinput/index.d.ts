...
declare namespace uinput {
  ...
  export function setup(options: ISetupOptions, callback: (err: Error, stream: WriteStream) => void): void;
  export function create(stream: WriteStream, options: ICreateOptions, callback: (err: Error) => void): void;
  export function send_event(stream: WriteStream, typeParam: number, code: number, value: number, callback: (err: Error) => void): void;
  export function key_event(stream: WriteStream, code: number, callback: (err: Error) => void): void;
  export function emit_combo(stream: WriteStream, code: number, callback: (err: Error) => void): void;

  export const BUS_VIRTUAL: any;
