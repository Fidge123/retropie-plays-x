...
declare namespace uinput {
  ...
  function setup(options: ISetupOptions, callback: (err: Error, stream: WriteStream) => void): void;
  function create(stream: WriteStream, options: ICreateOptions, callback: (err: Error) => void): void;
  function send_event(stream: WriteStream, typeParam: number, code: number, value: number, callback: (err: Error) => void): void;
  function key_event(stream: WriteStream, code: number, callback: (err: Error) => void): void;
  function emit_combo(stream: WriteStream, code: number, callback: (err: Error) => void): void;

  const BUS_VIRTUAL: any;
