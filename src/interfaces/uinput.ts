...
export interface IUinput {
  setup(options: ISetupOptions, callback: (err: Error, stream: WriteStream) => void): void;
  create(stream: WriteStream, options: ICreateOptions, callback: (err: Error) => void): void;
  send_event(stream: WriteStream, typeParam: number, code: number, value: number, callback: (err: Error) => void): void;
  key_event(stream: WriteStream, code: number, callback: (err: Error) => void): void;
  emit_combo(stream: WriteStream, code: number, callback: (err: Error) => void): void;
}
